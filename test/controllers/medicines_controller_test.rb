...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { molecule: @medicine.molecule, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity } }, as: :json
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { molecule: @medicine.molecule, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity } }, as: :json
    assert_response 200
  end
